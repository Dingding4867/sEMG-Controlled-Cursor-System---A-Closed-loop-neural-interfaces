...
H = [1, 0, 0;   % EMG1 contributes to +X velocity
     -1, 0, 0]; % EMG2 contributes to -X velocity%FILLIN
% postion, velocity, nerual activity(bias)
...
file_name = ['Lab 5 b exp3b_W and H CHANGED', '_ ', datestr(now),'.mat']; %FILLIN the ()
